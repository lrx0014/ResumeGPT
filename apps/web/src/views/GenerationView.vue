...
<template>
  <div class="page generation-detail">
    <PageHeader :title="title" description="Follow the complete writing, document design, review, and revision timeline."><RouterLink class="button" to="/generate">Back to applications</RouterLink></PageHeader>
